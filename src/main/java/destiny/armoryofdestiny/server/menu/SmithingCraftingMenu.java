package destiny.armoryofdestiny.server.menu;
...
public class SmithingCraftingMenu extends RecipeBookMenu<CraftingContainer> {
    ...
    public SmithingCraftingMenu(int p_39353_, Inventory p_39354_) {
        this(p_39353_, p_39354_, ContainerLevelAccess.NULL);
    }

    public SmithingCraftingMenu(int p_39356_, Inventory p_39357_, ContainerLevelAccess p_39358_) {
