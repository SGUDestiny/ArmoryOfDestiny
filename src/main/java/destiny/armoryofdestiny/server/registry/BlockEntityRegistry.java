...
public class BlockEntityRegistry {
    ...
    public static final RegistryObject<BlockEntityType<ArmorersTinkeringTableBlockEntity>> ARMORERS_ASSEMBLY_TABLE = BLOCK_ENTITIES.register("armorers_assembly_table", () -> BlockEntityType.Builder.of(ArmorersTinkeringTableBlockEntity::new, BlockRegistry.ARMORERS_FORGING_TABLE.get()).build(null));
